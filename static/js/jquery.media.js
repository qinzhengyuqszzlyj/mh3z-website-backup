...
(function ($) {
  ...
  $.fn.media.defaults.players = {
    ...
    winmedia: {
      ...
      eAttrs: {
        type:
          $.browser.mozilla && isFirefoxWMPPluginInstalled()
  ...
  $.fn.media.swf = function (el, opts) {
    if (!window.SWFObject && !window.swfobject) {
      ...
      if (opts.flashvars) {
        var a = [];
        for (var f in opts.flashvars) a.push(f + "=" + opts.flashvars[f]);
    ...
    // swfobject < v2
      ...
      for (var f in opts.flashvars) so.addVariable(f, opts.flashvars[f]);
      so.write($div[0]);
    }
  ...
  function generate(el, opts, player) {
    ...
    if (player == "iframe") {
      ...
      var a = [
        '<object width="' + opts.width + '" height="' + opts.height + '" ',
      ];
      for (var key in opts.attrs) a.push(key + '="' + opts.attrs[key] + '" ');
      ...
      for (var key in opts.attrs) a.push(key + '="' + opts.attrs[key] + '" ');
      for (var key in o.eAttrs || {}) a.push(key + '="' + o.eAttrs[key] + '" ');
      for (var key in opts.params) {
